...
public class GameController {
	...
	private void setupListeners() {
		// Mostrar pantalla de selecci�n de dificultad al presionar "Jugar"
	...
	private void startGame(int rows) {
		// Crear nueva matriz y pantalla de juego con el tama�o seleccionado
		...
		// Listener para volver al men� desde el juego
